...
<Project Type="Project" LVVersion="12008004">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="project" Type="Folder">
			<Item Name="Configure Front Panel Layout.vi" Type="VI" URL="../LabVIEW/project/Configure Front Panel Layout.vi"/>
		</Item>
		<Item Name="vi.lib" Type="Folder">
			<Item Name="NI_SE_Config FP Layout_Palette Launcher.xnode" Type="XNode" URL="../LabVIEW/vi.lib/Front Panel Layout/Configure Front Panel Layout/Palette Launcher/NI_SE_Config FP Layout_Palette Launcher.xnode"/>
			<Item Name="NI_SE_Config Front Panel Layout.lvlib" Type="Library" URL="../LabVIEW/vi.lib/Front Panel Layout/Configure Front Panel Layout/NI_SE_Config Front Panel Layout.lvlib"/>
			<Item Name="NI_SE_Front Panel Layout.lvlib" Type="Library" URL="../LabVIEW/vi.lib/Front Panel Layout/NI_SE_Front Panel Layout.lvlib"/>
		</Item>
		<Item Name="Adding new object layout classes.txt" Type="Document" URL="../Adding new object layout classes.txt"/>
		<Item Name="CreatingUserObjectLayoutClasses.txt" Type="Document" URL="../LabVIEW/vi.lib/Front Panel Layout/CreatingUserObjectLayoutClasses.txt"/>
